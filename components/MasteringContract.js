...
export default function MasteringContract({ name, artist, dashgoEmail, track, shareSplit, setCursorType }) {
    ...
    async function downloadPdf() {
        ...
        try{
            await html2canvas(input).then((canvas) => {
                ...
                pdf.save('[' + artist + '] master recording agreement.pdf');
            });
            setCursorType("auto");
        }
        catch(err) {
    ...
    async function downloadPng() {
        ...
        try{
            await html2canvas(input).then((canvas) => {
                ...
                a.download = '[' + artist + '] master recording agreement.png';
                a.click();
            });
    ...
    return(
        ...
        <br/>
            ...
            <p>GENERATE MASTERING AGREEMENT</p>
            <div className="row3">
            ...
            <div ref={pdfRef} className="pdf">
                <div className="title" >
                    ...
                    <h1>MASTER RECORDING AGREEMENT</h1>
                </div>
                

                <p>
                    This Master Recording Agreement (“Agreement”) is effective as of 
                ...
                <p>DashGo email: <strong>{dashgoEmail}</strong></p>
                <p style={{fontSize: "12px"}}>(If artist do not have a DashGo account, a new one will be created with the e-mail specified above)</p>
                ...
                <p>
                    Accounting periods should be paid within ninety (90) days after each release. DASHGO (“the Distributor”) will issue splits directly 
                    to the ARTIST’s PayPal account. The COMPANY shall not be obliged to prepare a statement or make a payment where the total sum due to the 
                    ARTIST is under twenty-five dollars ($25.00 US). Such amount, if applicable, will be carried forward to the next following statement.
                </p>
